...
export const SSL_OP_MICROSOFT_BIG_SSLV3_BUFFER = 0
export const SSL_OP_MICROSOFT_SESS_ID_BUG = 0
export const SSL_OP_MSIE_SSLV2_RSA_PADDING = 0
export const SSL_OP_NETSCAPE_CA_DN_BUG = 0
export const SSL_OP_NETSCAPE_CHALLENGE_BUG = 0
export const SSL_OP_NETSCAPE_DEMO_CIPHER_CHANGE_BUG = 0
export const SSL_OP_NETSCAPE_REUSE_CIPHER_CHANGE_BUG = 0
...
export const SSL_OP_SINGLE_DH_USE = 0
export const SSL_OP_SINGLE_ECDH_USE = 0
export const SSL_OP_SSLEAY_080_CLIENT_DH_BUG = 0
export const SSL_OP_SSLREF2_REUSE_CERT_TYPE_BUG = 0
export const SSL_OP_TLS_BLOCK_PADDING_BUG = 0
export const SSL_OP_TLS_D5_BUG = 0
