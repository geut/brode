...
Fork the project [on GitHub](https://github.com/geut/brode) and check out your copy locally.

```bash
$ git clone git@github.com:username/brode.git
$ cd brode
$ npm install
$ git remote add upstream git://github.com/geut/brode.git
```
